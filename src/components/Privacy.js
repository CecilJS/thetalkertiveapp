    ...
    render() {
        return (
            <div className="container" id="privacy" data-aos="zoom-in-up">
                ...
                <li>
                <strong>Website</strong> refers to The Talkertive, accessible from <a href="https://thetalkertive.co.uk/" target="_blank" rel="noopener noreferrer">The Talkertive</a>
                </li>
                <li>
